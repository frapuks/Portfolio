  ...
  return (
    <Box component="footer" bgcolor="primary.dark" sx={{position:'sticky', top:"100%"}} paddingTop={10} paddingBottom={10}>
      <Stack alignItems="center" spacing={3}>
        ...
        <Typography variant="body2" fontStyle="italic">"Vous pouvez vous entraîner à tirer 8 heures par jour, mais si votre technique n’est pas bonne, alors vous devenez juste très bon pour mal tirer." Michael Jordan</Typography>
        <Stack direction="row">
